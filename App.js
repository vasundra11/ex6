...
class App extends Component {
  constructor(props){
    <img src="https://thumbs.dreamstime.com/b/file-calc-pen-c-business-environment-gray-ballpoint-printed-document-large-calculator-table-closeup-45276430.jpg"></img>
    super(props);
    this.state = {
      display: "0",
      equation: ""
